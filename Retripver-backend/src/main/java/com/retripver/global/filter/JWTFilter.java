...
public class JWTFilter extends OncePerRequestFilter {
    ...
    protected boolean shouldNotFilter(HttpServletRequest httpServletRequest) throws ServletException {
        ...
        String[] excludeURIList = {
                "api-docs", "swagger-ui", "favicon.ico",
                "/auth/login", "/auth/logout",
                "/auth/signup", "/auth/exist/id", "/auth/exist/email", "/auth/email", "/auth/email/verify",
                "/auth/profile",
                "/auth/search",
                "/attraction/sidos", "/attraction/search", "/plan/search/", "/plan/copy/", "/user/rank",
                "/user/status/info", "/auth/info", "/plan/list/", "/attraction/sido/", "/plan/comparision"
        };
    ...
    protected void doFilterInternal(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse,
        ...
        // 다른 요청이 발생한 경우.
            ...
            if (accessToken == null || !jwtUtil.validateToken(accessToken) || authService.isBlackListToken(
                    accessToken)) {
