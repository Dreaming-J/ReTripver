...
public enum PlanErrorCode {
	NO_CARRY_OUT_COURSE_IN_PLAN(HttpStatus.INTERNAL_SERVER_ERROR.value(), "수행한 미션이 존재하지 않습니다."),
	FAIL_QUEST_CLEAR(HttpStatus.INTERNAL_SERVER_ERROR.value(), "퀘스트를 완료하는데 실패하였습니다."),
